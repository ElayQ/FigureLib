...
<h2>1. Напишите на C# библиотеку для поставки внешним клиентам, которая умеет вычислять площадь круга по радиусу и треугольника по трем сторонам.</h2>
<p></p>
<h3>Библиотека в папке FigureLib.</h3>
<p></p>
<h3>Юнит-тесты в папке FigureLibTests.</h3>
