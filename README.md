...
<h2>Задание 1</h2>
<p>1. Напишите на C# библиотеку для поставки внешним клиентам, которая умеет вычислять площадь круга по радиусу и треугольника по трем сторонам.
<br>Библиотека в папке FigureLib.
<br>Юнит-тесты в папке FigureLibTests.</p>
<br>
<h2>Задание 2</h2>
